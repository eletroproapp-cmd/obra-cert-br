      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div>
              <h4 className="font-semibold text-sm mb-2">Fase 1 - MVP (Em Desenvolvimento)</h4>
              <p className="text-sm text-muted-foreground">
                Checklist básico, assistente de orçamento, validação simples e geração de anexo PDF
              </p>
            </div>
            <div>
